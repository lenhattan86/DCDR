...
% alp = 0.602; [ A, a ] = getStepSizeSetting(1, 25, 1000, 1, alp); %( Start, End, stepStart, stepEnd, alpha )
...
%% V. Saving Results
performance_gap = (exp_cost_pred - sum(exp_offline_cost))/sum(exp_offline_cost)*100;
if ~exist('extraName')
    extraName='';
end
