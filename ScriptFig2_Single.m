...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%GENERATE_DATA = 0;
GEN_FILE = 'ScriptFig2_Single.mat';
extraName = 'Fig2_S_';
...
alp = 0.602; [ A, a ] = getStepSizeSetting(1, 25, 5, 1, alp); %( Start, End, stepStart, stepEnd, alpha )
...
NoLT_NoGLB = [0, 0, 0, 0];
NoLT_NoGLB_ignoreQDelay = [0, 0, 0, 0];
fixedLT_NoGLB = [0, 0, 0, 0];
NoLT = [0, 0, 0, 0];
fixedLT = [0, 0, 0, 0];
expect_SGEA = [0, 0, 0, 0];
if ~SKIP_PLOTTING     
